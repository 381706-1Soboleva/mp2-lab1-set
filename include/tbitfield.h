...
private:
  ...
  TELEM *m; // память для представления битового поля
	int  length; // к-во эл-тов Мем для представления бит.поля
...
//   массив pМем рассматривается как последовательность length элементов
